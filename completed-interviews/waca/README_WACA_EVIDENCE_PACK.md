...
2. The new page `/waca/upa-evidence-lab.html` will work with the existing `/waca/assets/js/questions-data.js`.
3. To enrich the **existing** `/waca/question-bank.html` renderer too, insert the overlay script between the current question data and renderer scripts:

```html
<script src="/waca/assets/js/questions-data.js"></script>
<script src="/waca/assets/js/upa-evidence-overlay.js?v=20260811"></script>
<script src="/waca/assets/js/question-bank.js"></script>
```

4. Optionally add navigation links to:
   - `/waca/upa-evidence-lab.html`
   - `/waca/upa-evidence-atlas.html`
...
- `/waca/upa-visual-study.html` contains the full visual study library.
...
- `/waca/upa-evidence-lab.html`
- `/waca/upa-evidence-atlas.html`
- `/waca/upa-visual-study.html`
- `/waca/upa-evidence-atlas-standalone.html`
- `/waca/upa-visual-study-standalone.html`
- `/waca/UPA_EVIDENCE_SOURCE_AUDIT.md`
- `/waca/PATCH_EXISTING_QUESTION_BANK.txt`
