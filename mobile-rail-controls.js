...
(() => {
  ...
  if (!document.getElementById('v5-dropin-styles')) {
    ...
    style.textContent = `
      ...
      .v5-career-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:14px}.v5-career-actions a{text-decoration:none}.v5-career-actions .v5-secondary{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:0 16px;border-radius:999px;border:1px solid var(--v5-border);background:#fff;color:#0f172a;font:800 10px/1 var(--mono,monospace)}.v5-career-actions .v5-secondary:hover{border-color:#94a3b8}
  ...
  /* Career CTAs on the home/contact surfaces where a recruiter expects them. */
  const target = isHome
    ? document.querySelector('.hero-actions')
    : document.querySelector('main .hero-actions, main .contact-primary-actions, main .contact-actions, main .cta-grid');

  if (target && !document.querySelector('.v5-career-actions')) {
    const wrap = document.createElement('div');
    wrap.className = 'v5-career-actions';
    wrap.innerHTML = `
      <a class="v5-secondary" href="CVSalama.pdf" target="_blank" rel="noopener">View Executive CV ↗</a>
