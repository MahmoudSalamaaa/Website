...
(function(){
  ...
  const active=document.querySelector('.nav a[href="/msf-waca-prep-2026/question-bank.html"]');
  if(active&&active.parentElement&&!document.querySelector('.nav a[href="/msf-waca-prep-2026/upa-visual-study.html"]')){
    const a=document.createElement('a');a.href='/msf-waca-prep-2026/upa-visual-study.html';a.innerHTML='<span class="dot"></span><span class="en-only">UPA Visual Cases</span><span class="ar-only">الحالات العملية المصورة</span>';
