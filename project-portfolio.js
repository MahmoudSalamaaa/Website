...
(() => {
  ...
  const featured = [
    ...
    {name:'Microsoft Dynamics 365 Enterprise Integration',type:'Data & Integration',period:'2020–Present',description:'Governed integration connecting UPA operational workflows with Microsoft Dynamics 365 across finance, procurement, inventory and CRM, including mapping, reconciliation, testing and production readiness; integration scope only, not Dynamics ERP/CRM implementation ownership.'},
  ...
  const selectedDescriptions = {
    1:'National healthcare procurement and medical-supply ecosystem spanning 38K+ current users, 5,900+ government healthcare entities, nearly 90K affiliated operational locations and 2K+ suppliers, led through re-architecture, migration, cutover, stabilization and live operations.',
    2:'Governed e-tender and institutional procurement workflows covering evaluation, committees, approvals and award governance.',
    3:'Electronic pharmacy capability within the MedIQ ecosystem supporting governed healthcare supply workflows.',
    5:'Medical-storage validation and inventory governance supporting controlled stock visibility and operational compliance.',
    6:'Digital budgeting capability connecting allocation, demand and procurement controls.',
    ...
    11:'Private-cloud platform supporting controlled compute, storage and network resources with cost, capacity and consumption optimization.',
    16:'Customer-service and technical-support platform supporting operational service delivery and issue handling.',
    17:'MedIQ mobile capability supporting operational workflows beyond the desktop environment.',
    18:'Government-sector inventory registration and follow-up supporting national inventory governance and visibility.',
    ...
    28:'National strategic dashboard consolidating governed operational and executive indicators.',
    29:'Dynamic reporting engine supporting reusable operational reporting across governed data sources.',
    30:'Supply and procurement analytics enablement supporting operational insight and decision support.',
    31:'Real-time notification service supporting governed operational alerts across enterprise workflows.',
    32:'Order-tracking capability supporting status visibility across procurement and supply workflows.',
    33:'Entity demand-planning capability supporting institutional planning and consolidated procurement demand.',
    34:'SMS and notification integration supporting operational communications and governed alerts.',
    35:'Financial and product-data auditing supporting reconciliation, quality control and accountable reporting.',
    36:'Supply-chain system enhancements across procurement, logistics and operational workflows.',
