...
(function(){
  ...
  let plan={}; try{plan=JSON.parse(localStorage.getItem('msfWacaReady2026Plan')||'{}')||{}}catch(e){}
  ...
  days.forEach(d=>d.querySelector('.sprint-check')?.addEventListener('click',()=>{plan[d.dataset.day]=!plan[d.dataset.day];localStorage.setItem('msfWacaReady2026Plan',JSON.stringify(plan));syncPlan()}));syncPlan();
