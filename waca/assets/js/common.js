(function(){
  ...
  const lang=localStorage.getItem('msfWacaReady2026Lang')||'en';
  const theme='light';
  body.classList.add('lang-'+lang); root.lang=lang; root.dir=lang==='ar'?'rtl':'ltr'; root.dataset.theme='light'; try{localStorage.removeItem('msfWacaReady2026Theme')}catch(e){}
  ...
  window.setLang=function(l){
    body.classList.remove('lang-en','lang-ar'); body.classList.add('lang-'+l); root.lang=l; root.dir=l==='ar'?'rtl':'ltr'; localStorage.setItem('msfWacaReady2026Lang',l);
    document.dispatchEvent(new CustomEvent('msf-language-change',{detail:{lang:l}}));
  };
  window.toggleTheme=function(){root.dataset.theme='light';try{localStorage.removeItem('msfWacaReady2026Theme')}catch(e){}};
  ...
  if(page && page!=='index.html') {
    try { localStorage.setItem('msfWacaReady2026LastPage', page); localStorage.setItem('msfWacaReady2026LastTitle', document.title||page); localStorage.setItem('msfWacaReady2026LastSeen', new Date().toISOString()); } catch(e) {}
  }
