(function(){
  ...
  let state = {};
  try { state = JSON.parse(localStorage.getItem('msfWacaReady2026EvidenceState') || '{}') || {}; } catch(e){}
  ...
  function save(){ localStorage.setItem('msfWacaReady2026EvidenceState', JSON.stringify(state)); }
