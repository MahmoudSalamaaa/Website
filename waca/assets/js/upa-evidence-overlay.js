/*
 ...
 Version: 2026-08-12 FINAL MEMORIZE
 Purpose:
...
(function () {
  ...
  // Final study wording: the answer talks as Mahmoud, never instructs Mahmoud what to say.
  const FINAL_FULL_EN = {
    1:[
      "• WHY MSF — I want my technology experience to support a mission with direct human impact, not only a corporate objective.",
      "• PERSONAL CONNECTION — My wife works with MSF Egypt, and seeing the organization more closely strengthened my respect for its humanitarian work. The decision to apply is my own professional choice.",
      "• VALUE I BRING — My background in healthcare systems, supply, data and digital transformation can help keep operations reliable, secure and well supported."
    ].join("\n"),
    58:[
      "• ANSWER — One project was delayed because I underestimated a dependency on an external vendor's schedule.",
      "• WHAT I DID — I communicated the delay, protected the most important scope and revised the plan around confirmed dependencies instead of hiding the risk.",
      "• LESSON — I now expose external dependencies earlier, add contingency and review schedule risk well before the deadline."
    ].join("\n"),
    92:[
      "• ANSWER — My professional technical English is strong. My French is still below the professional level required for this role, and I am improving it actively.",
      "• WHAT I AM DOING — I use structured daily study, technical and management vocabulary, speaking practice and interview rehearsal.",
      "• AT MSF — I will keep improving quickly and use clear written follow-up and approved language support for critical nuance until my French reaches the required level."
    ].join("\n"),
    94:[
      "• ANSWER — Yes. I am prepared for mobility across WaCA intervention zones, subject to MSF security and travel protocols.",
      "• HOW I WORK — I travel with a clear operational objective, coordinate with mission and security leadership, and leave behind documented improvements or stronger local capability.",
      "• PRINCIPLE — Mobility supports service ownership, but an IT need never overrides a field-security decision."
    ].join("\n"),
    95:[
      "• ANSWER — My direct NGO experience is limited, but the core systems-management problems are familiar: critical healthcare systems, distributed users, supply operations, data, vendors, security and continuity.",
      "• REAL EXPERIENCE — At UPA I have led technology where procurement, inventory, reporting, integrations and user support directly affect healthcare operations.",
      "• VALUE TO MSF — I bring mature enterprise-systems leadership and I will learn the humanitarian context with humility rather than assume government and NGO environments are identical."
    ].join("\n"),
    96:[
      "• ANSWER — I am not moving away from responsibility; I am moving toward a role where technology directly supports humanitarian medical operations across several countries.",
      "• WHY NOW — I have already led large national systems, and WaCA offers a different challenge: field systems, regional operations, continuity, integration and capacity building.",
      "• COMMITMENT — I understand the mobility and French requirements and I would make the move deliberately, not as a temporary step."
    ].join("\n"),
    103:[
      "• ANSWER — I do not give the board a simple yes or no. I show resilience by critical service: agreed RTO/RPO, recent incidents, tested restores or failovers, unresolved single points of failure and major vendor dependencies.",
      "• FROM MY WORK — At UPA I have governed business-critical systems with clear service ownership, escalation, continuity and recovery expectations.",
      "• BOARD DECISION — I finish with which capabilities we can recover confidently, which remain exposed, the operational impact and the decision or investment required."
    ].join("\n")
  };

  const FINAL_FULL_AR = {
    1:[
      "• لماذا MSF — أريد أن أستخدم خبرتي التقنية في عمل له أثر إنساني مباشر، وليس فقط هدفاً تجارياً.",
      "• الارتباط الشخصي — زوجتي تعمل في MSF مصر، ورؤيتي للمنظمة عن قرب زادت احترامي لعملها الإنساني. لكن قرار التقديم هو اختياري المهني أنا.",
      "• ما أقدمه — خبرتي في أنظمة الصحة والإمداد والبيانات والتحول الرقمي تساعدني على دعم عمليات موثوقة وآمنة ومستقرة."
    ].join("\n"),
    58:[
      "• الإجابة — تأخر أحد المشروعات لأنني قللت من أثر الاعتماد على الجدول الزمني لمورد خارجي.",
      "• ما فعلته — أوضحت التأخير، وحميت الجزء الأهم من النطاق، وأعدت ترتيب الخطة على أساس الاعتماديات المؤكدة بدلاً من إخفاء الخطر.",
      "• الدرس — أصبحت أظهر الاعتماديات الخارجية مبكراً، وأضع هامشاً مناسباً، وأراجع مخاطر الجدول قبل الموعد النهائي بوقت كافٍ."
    ].join("\n"),
    92:[
      "• الإجابة — الإنجليزية المهنية والتقنية لدي قوية، أما الفرنسية فما زالت أقل من المستوى المهني المطلوب للوظيفة وأنا أعمل على تطويرها بجدية.",
      "• ما أفعله — لدي دراسة يومية منظمة، ومفردات تقنية وإدارية، وتدريب على المحادثة وأسئلة المقابلة.",
      "• في MSF — سأواصل رفع مستواي بسرعة، وأستخدم توثيقاً واضحاً ودعماً لغوياً معتمداً في التفاصيل الحساسة إلى أن أصل للمستوى المطلوب."
    ].join("\n"),
    94:[
      "• الإجابة — نعم، أنا مستعد للتنقل داخل مناطق تدخل WaCA مع الالتزام الكامل بإجراءات الأمن والسفر في MSF.",
      "• أسلوبي — أذهب بهدف تشغيلي واضح، وأنسق مع قيادة البعثة والأمن، وأترك وراء الزيارة تحسيناً موثقاً أو قدرة أقوى لدى الفريق المحلي.",
      "• المبدأ — احتياج تقني لا يبرر أبداً تجاوز قرار أمني ميداني."
    ].join("\n"),
    95:[
      "• الإجابة — خبرتي المباشرة في المنظمات غير الحكومية محدودة، لكن جوهر إدارة الأنظمة مألوف لي: أنظمة صحية حرجة، مستخدمون موزعون، إمداد، بيانات، موردون، أمن واستمرارية.",
      "• من خبرتي — في هيئة الشراء الموحد قدت تقنيات ترتبط فيها المشتريات والمخزون والتقارير والتكاملات ودعم المستخدمين مباشرة بالتشغيل الصحي.",
      "• ما أقدمه لـMSF — أقدم خبرة مؤسسية ناضجة، وسأتعلم خصوصية العمل الإنساني بتواضع دون افتراض أن بيئة الحكومة وبيئة MSF متطابقتان."
    ].join("\n"),
    96:[
      "• الإجابة — أنا لا أبتعد عن المسؤولية؛ بل أتجه إلى دور تدعم فيه التكنولوجيا عمليات طبية إنسانية مباشرة عبر عدة دول.",
      "• لماذا الآن — قدت بالفعل أنظمة وطنية كبيرة، وWaCA تقدم تحدياً مختلفاً يجمع الأنظمة الميدانية والاستمرارية والتكامل وبناء القدرات.",
      "• الالتزام — أفهم متطلبات التنقل والفرنسية، وسأتخذ هذه الخطوة كاختيار مهني مقصود وليس كمرحلة مؤقتة."
    ].join("\n"),
    103:[
      "• الإجابة — لا أعطي مجلس الإدارة إجابة نعم أو لا فقط. أعرض مرونة كل خدمة حرجة من خلال RTO/RPO، الحوادث الأخيرة، اختبارات الاستعادة أو التحويل، ونقاط الفشل أو الاعتماديات غير المحلولة.",
      "• من خبرتي — في هيئة الشراء الموحد أدرت أنظمة حرجة مع ملكية واضحة للخدمة والتصعيد والاستمرارية ومتطلبات التعافي.",
      "• القرار المطلوب — أختم بما نستطيع استعادته بثقة، وما زال معرضاً للخطر، والأثر التشغيلي، والقرار أو الاستثمار المطلوب."
    ].join("\n")
  };

  function directCoreEn(q){
    let t=String(q.short_answer_en||q.original_answer_en||q.answer_en||"").replace(/\s+/g," ").trim();
    t=t.replace(/^I would be completely transparent:\s*/i,"");
    t=t.replace(/^I would answer with\s+/i,"I answer with ");
    t=t.replace(/^I would use\s+/i,"I use ");
    t=t.replace(/^I would present\s+/i,"I present ");
    t=t.replace(/\s+In the interview I would.*$/i,"");
    t=t.replace(/\s+In the interview, I would.*$/i,"");
    return fastShort(t,34);
  }

  function directCoreAr(q){
    let t=String(q.original_answer_ar||q.answer_ar||"").replace(/\s+/g," ").trim();

    // Remove old coaching/evidence appendices from the original dataset.
    for(const cut of ["الربط بخبرتي العملية:","الربط بخبرتي:","وفي المقابلة سأستخدم","في المقابلة سأستخدم","في المقابلة سأوضح"]){
      const i=t.indexOf(cut); if(i>0) t=t.slice(0,i).trim();
    }

    // Convert imperative coaching into first-person answer wording.
    t=t.replace(/^ابدأ\s+/,"أبدأ ");
    t=t.replace(/^استخدم\s+/,"أستخدم ");
    t=t.replace(/^اربط\s+/,"أربط ");
    t=t.replace(/^حدد\s+/,"أحدد ");
    t=t.replace(/^افحص\s+/,"أفحص ");
    t=t.replace(/\. استخدم\s+/g,". أستخدم ");
    t=t.replace(/\. اربط\s+/g,". أربط ");
    t=t.replace(/\. حدد\s+/g,". أحدد ");
    t=t.replace(/\. افحص\s+/g,". أفحص ");

    return fastShort(t,36);
  }

  const TRANSFER_AR = {
    integration:"في MSF أطبق نفس المبدأ: مالك واضح لكل تكامل، بيانات محددة، مراقبة للأخطاء، إعادة محاولة ومطابقة قبل اعتبار العملية ناجحة.",
    architecture:"في MSF أحافظ على أبسط معمارية تحقق الاعتمادية وتقلل التعقيد وتحافظ على مصدر واحد موثوق للبيانات التشغيلية.",
    procurement:"في MSF أركز على تتبع العملية من الاحتياج حتى الاستلام، مع مسؤوليات واضحة واستثناءات يمكن متابعتها.",
    supply:"في MSF أضمن استمرار العمل الميداني مع دقة المخزون والتتبع، خصوصاً في المواقع ذات الاتصال الضعيف.",
    offline:"في MSF أسمح باستمرار العمل محلياً، لكن أي حركة تظل معلقة حتى تتم المزامنة والتحقق قبل اعتمادها مركزياً.",
    data:"في MSF لا أعتمد مؤشراً قبل تحديد تعريفه ومالكه ومصدره وجودته، ثم أبني التقارير والقرارات فوق هذه القاعدة.",
    security:"في MSF أطبق أقل صلاحية ممكنة، وفصل المسؤوليات، وتسجيل العمليات الحساسة، مع توازن عملي بين الحماية وسهولة العمل الميداني.",
    reliability:"في MSF أستعيد الخدمة بأمان أولاً، وأحافظ على التواصل أثناء الحادث، ثم أعالج السبب وأختبر التعافي حتى لا يتكرر.",
    performance:"في MSF أقيس عنق الزجاجة أولاً، ثم أعالج السبب الحقيقي بأبسط تغيير قبل زيادة الموارد أو التعقيد.",
    delivery:"في MSF أربط التقدم بمخرجات مقبولة واختبار مستخدم وخطة رجوع ودعم بعد التشغيل، وليس بنسبة إنجاز شكلية.",
    adoption:"في MSF أقيس نجاح التغيير بقدرة المستخدم على إنجاز عمله وانخفاض الأخطاء، ثم أعدل التدريب أو النظام حسب الواقع.",
    support:"في MSF أحول المشكلات المتكررة إلى معرفة وتدريب وتحسين للنظام بدلاً من إغلاق كل تذكرة بمعزل عن الأخرى.",
    people:"في MSF أقود بتوقعات واضحة، واستماع وتوجيه وإزالة عوائق، ثم متابعة عادلة للنتائج داخل فريق متعدد الثقافات.",
    executive:"في MSF أربط كل استثمار تقني بنتيجة تشغيلية واضحة ومالك قرار ومقياس أثر قبل التوسع.",
    cloud:"في MSF أختار خدمة AWS حسب الاحتياج الفعلي للأمان والاعتمادية والتكلفة والتشغيل، مع وضوح حدود خبرتي المباشرة.",
    general:"في MSF أبدأ بأثر المشكلة على الميدان، أحدد المسؤولية، أنفذ أبسط حل موثوق، ثم أتابع النتيجة."
  };
  ...
  qs.forEach(q => {
    ...
    const hcFinal=HUMAN_CASES[realCase.key]||HUMAN_CASES.general;
    if(FINAL_FULL_EN[q.id]){
      q.answer_en=FINAL_FULL_EN[q.id];
    }else{
      q.answer_en=[
        "• ANSWER — "+directCoreEn(q),
        "• FROM MY WORK — "+fastShort(hcFinal.evidence,40),
        "• AT MSF — "+fastShort(realCase.transfer_en,26)
      ].join("\n");
    }
    if(FINAL_FULL_AR[q.id]){
      q.answer_ar=FINAL_FULL_AR[q.id];
    }else{
      q.answer_ar=[
        "• الإجابة — "+directCoreAr(q),
        "• من خبرتي — "+_ar[0],
        "• في MSF — "+(TRANSFER_AR[_k]||TRANSFER_AR.general)
      ].join("\n");
    }
    ...
    q.visual_asset = `/msf-waca-ready-2026/assets/visuals/${realCase.visual}`;
  ...
  window.WACA_UPA_EVIDENCE = {
    version: "2026-08-12-final-memorize-v1",
